...
const Introduction = ({setupInProgress}) => {
  ...
  return (
    <IntroductionPage title="Get started with the Rayan sales channel">
      <FeatureCard
        title="Sell your products on rayan"
        description="Let customers discover your brand and purchase your products directly on the rayan marketplace."
        feature="rayan Marketplace"
        badgeText="Free"
        primaryAction={{
